...
class CreateKtpPage extends StatelessWidget {

  // Variable
  GlobalKey<FormState> _createktpform = GlobalKey<FormState>();
                      ...
                      Consumer<DropdownService>(
                        builder: (BuildContext context, dropdownService, Widget? child) {
                          return ElevatedButton(
                            onPressed: () {
                              if(_createktpform.currentState!.validate()){
                                ...
                                PendudukUseCases().storePenduduk(
                                ...
                                ScaffoldMessenger.of(context).showSnackBar(
                                    SnackBar(content: Text('Berhasil menambah penduduk')
                                    )
                                );
                              }else{
                                ScaffoldMessenger.of(context).showSnackBar(
